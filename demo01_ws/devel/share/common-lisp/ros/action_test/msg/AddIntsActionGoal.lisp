...
(cl:defclass <AddIntsActionGoal> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (goal
    :reader goal
    :initarg :goal
    :type action_test-msg:AddIntsGoal
    :initform (cl:make-instance 'action_test-msg:AddIntsGoal)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <AddIntsActionGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddIntsActionGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name action_test-msg:<AddIntsActionGoal> is deprecated: use action_test-msg:AddIntsActionGoal instead.")))
