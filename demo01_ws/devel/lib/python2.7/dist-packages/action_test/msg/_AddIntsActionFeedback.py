...
"""autogenerated by genpy from action_test/AddIntsActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class AddIntsActionFeedback(genpy.Message):
  ...
  _type = "action_test/AddIntsActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','action_test/AddIntsFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = action_test.msg.AddIntsFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = action_test.msg.AddIntsFeedback()
